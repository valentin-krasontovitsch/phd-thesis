...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{The Loday functor for finite sets}
    ...
    \begin{lem}\label{lem_loday_functor_fixed_points}
      ...
      \begin{proof}
        To obtain the above map, consider the full subcategory $\{S\}$ of finite sets and the restictions of $\tilde{\cJ}$, $\cJ$, and the constant functor $\sS_*$ along the inclusion $\{S\} \to \Fin$. This gives rise to a map of bimodules
        \begin{displaymath}
