...
\section{Iterated THH - Loday Functor}
  ...
  \begin{defn}\label{def_lax_functor_V_to_eW}
    We may consider $V$, the category of spans of finite sets, as a bicategory by making the set of morphisms $V(X,Y)$ between two finite sets into a category with only identity morphisms, also called a discrete category (cf. \ref{lem_discrete_bicategory}. With this we may define a lax functor $L: V \to W$ by 
  \end{defn}
