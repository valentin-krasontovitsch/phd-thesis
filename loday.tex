...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{The Loday functor for finite sets}
    ...
    \begin{defn}\label{def_rectification_of_G^A}
      Consider the functor $\tilde{\cJ} \colon V \to \Cat_*$ and the left lax transformation $\tilde{e} \colon \tilde{\cJ} \to \cJ$ which we obtain by applying Street's first construction (the pointed version, cf. Defs.~\ref{def_streets_first_construction_functor},~\ref{def_streets_first_construction_transformation}) in the context $\cD \defas V$ and $F \defas \cJ$.
    \end{defn}
