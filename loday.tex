...
\section{Iterated THH - Loday Functor}
  ...
  \begin{defn}\label{def_bicategory}
    ...
    \begin{itemize}
      ...
      \item For each triple $a\myrightarrow{h}b\myrightarrow{g}c\myrightarrow{f}d$ of 1-morphisms an isomorphism in the category $\cC(a,d)$%
      \begin{displaymath}
        \begin{xy}
          \xymatrix{
    ...
    \begin{itemize}
      ...
      \item Given four composable 1-arrows $\bullet\myrightarrow{i}\bullet\myrightarrow{h}\bullet\myrightarrow{g}\bullet\myrightarrow{f}\bullet$, we have the following commutative diagram
      ...
      \begin{displaymath}
        ...
        \end{xy}
      \end{displaymath}
      where $\id_f$ is the 2-arrow identity on the object $f$ in its morphism category.
    \end{itemize}
  \end{defn}
