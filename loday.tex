...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{The left lax transformation $G^A$}
    ...
    \begin{defn}\label{def_left_lax_transformation_S}
      ...
      We choose a strong symmetric monoidal functor $S: \Sigma \to \sS_*$ with $S(\{1\}) = S^1$ (one possible such choice is to let $S(X) = \bigwedge_{x \in X} S^1$ for any finite set $X$).
