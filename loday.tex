  ...
  \subsection{The Loday functor for finite sets}
    ...
    \begin{defn}\label{def_rectification_of_G^A}
      ...
      r \colon \tilde{\cJ}^e = \tilde{\cJ}^{\op} \wedge \tilde{\cJ} 
        \myrightarrow{\tilde{\cJ^{\op}} \wedge e} \tilde{\cJ}^{\op} \wedge \cJ,
      \end{displaymath}
      while 
      \begin{displaymath}
      ...
      for a pointed category $\cC$ (rf. Lem.~%
    ...
    constant functor with value symmetric spectra. By applying the functor
    $\hocolim$ (cf. Def.~\ref{def_hocolim}) we obtain a functor
    \begin{displaymath}
