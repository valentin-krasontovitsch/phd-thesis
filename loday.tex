  ...
  \subsection{The Loday functor for finite sets}
    ...
    \begin{defn}\label{def_rectification_of_G^A}
      ...
      \begin{displaymath}
        \Fin \to \CAT_*.
      \end{displaymath}
      We introduce the notation $\cG^A \defas G^A \circ p_2$ for the sake of brevity. Note that we have obtained ... What? \comment{TODO:} We should now be able to describe a functor from $\Fin$ to some category of bimodules. Do this here!?
    \end{defn}
