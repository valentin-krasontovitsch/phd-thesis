  ...
  \subsection{Left lax transformations, bimodules and homotopy colimits}
    ...
    \begin{defn}\label{def_left_lax_transformation}
      ...
      \begin{itemize}
        ...
        \end{displaymath}
      \end{itemize}
      These data is subject to the following relations, which we express in composition and unit diagrams: For composable $A \myrightarrow{f} B \myrightarrow{g} C$
      \begin{displaymath}
        \begin{xy}
          \xymatrix{
