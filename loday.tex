...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{Left lax transformations, bimodules and homotopy colimits}
    ...
    \begin{defn}\label{def_hocolim}
      ...
      This is sometimes referred to as Hochschild type simplicial structure, as it resembles the structure of the comples used by Hochschild to define the homology theory named after him, and it is an easy exercise to show that these operators fulfill the simplicial relations.\\
      ...
      \end{displaymath}
      which assemble into the desired natural transformation.
