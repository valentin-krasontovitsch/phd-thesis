...
\subsection{The Loday functor for finite sets}
  ...
  \begin{lem}\label{lem_loday_functor_fixed_points}
    ...
    \begin{proof}
      ...
      provided in the definition mentioned above. This gives us the following
      commutative diagram:
      % TODO explain where morphism comes from
      % morphism of simplicial sets, degree wise
      % TODO this will also show how the above is a bimodule...
      % it's not - taking fixed points is no good
      % TODO how is the lower horizontal morphism induced?
      % stupid answer - degree-wise
      % come up with a better answer!
      % TODO how can we apply the same stuff on the RHS?
      % TODO is \cJ(S)^G \cong \cJ(S/G)?
      % Yes, it is - at least on the level of objects.
      % Not so sure about morphisms though...
      % TODO why are we now in the situation from before?
      \begin{displaymath}
        \xymatrix@C+2em{
