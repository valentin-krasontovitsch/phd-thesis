...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{The left lax transformation $G^A$}
    ...
    \begin{defn}\label{def_left_lax_transform_G^A}
      Given two pointed simplicial sets $X$ and $Y$, we define a symmetric spetrum of functions $\Hom(X,Y)$ given in degree $n$ by the pointed simplicial function object $\map_*(X,Y \wedge S^n)$. One may check that this coincides with the internal hom object of symmetric spectra as found in Example 3.38 of 
