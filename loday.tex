...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{Rectification}
    ...
    \begin{defn}\label{def_streets_construction_right_transformations}
      ...
      Given a morphism $f \colon d \to d^\prime$, recall that $\tilde{F}(f)$ was given by postcomposition in the first entry on objects and the identity on morphisms, while $\tilde{\rho}_d$ only acts on the second entry of objects, and as mentioned is independent of $d$ for morphisms.
    \end{defn}
    %
