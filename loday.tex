...
\subsection{The Loday functor for finite sets}
  ...
  \begin{lem}\label{lem_loday_functor_fixed_points}
    ...
    \begin{proof}
      ...
      \end{displaymath}
      In the above diagram, the equalities are valid due to the following
      ...
      \end{displaymath}
      This diagram is commutative, for ...
      % TODO name \tilde{\phi} above!
      % TODO give reason why commutative
      Finally we obtain ...
      % TODO fix final diagram
      \begin{displaymath}
      \noindent\makebox[\textwidth]{ \xymatrix@C+2em{
