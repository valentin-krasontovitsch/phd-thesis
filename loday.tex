  ...
  \subsection{Left lax transformations, bimodules and homotopy colimits}
    ...
    \begin{defn}\label{def_left_lax_transformation}
      ...
      \begin{itemize}
        ...
        \end{displaymath}
      \end{itemize}
      This data is subject to the following relations, which we express in composition and unit diagrams: For composable $A \myrightarrow{f} B \myrightarrow{g} C$
      \begin{displaymath}
        \begin{xy}
          \xymatrix@C+=3em{
            F^\prime(g) \circ (F^\prime(f) \circ \sigma_a)
              \ar[r]^{\alpha}
              \ar[d]_-{F^\prime(g) \circ \sigma_f}
            &
            (F^\prime(g) \circ F^\prime(f)) \circ \sigma_A
              \ar[r]^-{F^\prime(g,f) \circ \sigma_A}
            &
            F^\prime(g \circ f) \circ \sigma_A
              \ar[dr]^{\sigma_{g \circ f}}
            &
            %
            \\
            F^\prime(g) \circ (\sigma_B \circ F(f))
              \ar[d]_-{\alpha}
            &&&
            \sigma_C \circ F(gf)
            \\
            ...
            &
            (\sigma_C \circ F(g)) \circ F(f)
              \ar[r]_-{\alpha}
            &
            \sigma_C \circ (F(g) \circ F(f))
              \ar[ur]_{\sigma_C \circ F(g,f)}
            &
            %
          }
        \end{xy}
      ...
      \begin{displaymath}
        \begin{xy}
          \xymatrix{
            & F^\prime(\id_A) \circ \sigma_A
              \ar[dd]^{\sigma_{\id_A}}
            \\
            \sigma_A
              \ar[ur]^{F^\prime \circ \sigma_A}
              \ar[dr]_{\sigma_A \circ F_A}
            &
            %
            \\
            & \sigma_A \circ F(\id_A)
