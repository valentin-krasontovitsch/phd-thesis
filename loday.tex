...
\section{Iterated THH - Loday Functor}
  ...
  \subsection{The left lax transformation $G^A$}
    ...
    \begin{defn}\label{def_left_lax_transformation_S}
      ...
      \end{displaymath}
    where $\Sigma_+: \Fin \to \Cat_*$ is the weak functor obtained by applying the constructions from Defs. \ref{def_functor_iW_to_Cat_aka_abstract_loday} and \ref{def_added_basepoint_extending_functor} to the inclusion
    \end{defn}
