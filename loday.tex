...
\section{Iterated THH - Loday Functor}
  ...
  \begin{defn}\label{def_bicategory_functor}
    ...
    \end{itemize}
    such that $\phi$ is natural both in 1-morphisms and in objects, and the following diagrams commute for all composable morphisms $a \myrightarrow{f} b \myrightarrow{g} c \myrightarrow {h} d$:
    \begin{gather*}
