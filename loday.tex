  ...
  \subsection{The Loday functor for finite sets}
    ...
    \begin{defn}\label{def_rectification_of_G^A}
      ...
      \begin{displaymath}
        \Fin \to \CAT_*.
      \end{displaymath}
      % TODO revise this notation - writing r alone does not make so much sense
      ...
      invertible. However, when fixing an object ... \comm{complete remark}
    \end{defn}
    %
    ...
    \begin{lem}\label{lem_loday_functor_fixed_points}
      ...
      \begin{proof}
        ...
        \end{displaymath}
        where the vertical maps are isomorphisms (described in the Lemma
        ...
        \ref{rem_streets_construction_is_cofinal}), the lower horizontal arrow
